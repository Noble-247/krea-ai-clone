    ...
    <section className='px-4 sm:px-6 py-4 sm:py-8'>
      <div className='flex flex-col md:flex-row gap-6 max-w-[95%] mx-auto'>
        ...
        <Card className="flex-1 bg-[url('/images/futuristic-ai-woman-1.jpg')] bg-cover via-pink-400 to-purple-500 border-0 overflow-hidden relative">
          ...
          <div className='relative px-4 sm:px-8 h-64 sm:h-80 flex flex-col justify-between'>
            <div className='text-xs text-white/80 uppercase tracking-wide'>
              FEATURED MODEL
            </div>
            <div className='pt-8 sm:pt-16 pb-4 flex flex-col h-full justify-between'>
              <div>
                <h2 className='text-3xl sm:text-5xl font-bold text-white mb-2 text-center mt-4 sm:mt-10'>
                  WAN 2.2
                </h2>
                <div className='flex flex-col sm:flex-row justify-between items-start sm:items-end mt-6 sm:mt-12'>
                  <div>
